...
/**
 * 场景动作组 REST 接口，前缀 {@code /catalog/scenes}。
 *
 * <p>示例：{@code GET /catalog/scenes} 列出场景；
 * {@code POST /catalog/scenes/{id}/execute} 手动触发场景。
 */
@Validated
@RestController
@RequestMapping("/catalog/scenes")
public class CatalogSceneController {
    ...
    public CatalogSceneController(CatalogApplyService applyService, CatalogActionService actions) {
